...
import ziweiyang.toppine.com.oschinadome.adapter.BaseListAdapter;
...
import ziweiyang.toppine.com.oschinadome.ui.view.SuperRefreshLayout;
...
public abstract class BaseListFragment<T> extends BaseFragment implements
    ...
    protected void initWidget(View root) {
        ...
        mFooterView = LayoutInflater.from(getContext()).inflate(R.layout.recycler_footer_view, null);
