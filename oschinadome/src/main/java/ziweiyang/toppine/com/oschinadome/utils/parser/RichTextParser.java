package ziweiyang.toppine.com.oschinadome.utils.parser;
...
import ziweiyang.toppine.com.oschinadome.bean.Project;
...
//                        ProjectDetailActivity.show(context, project);//TODO
                    }
                };
                builder.setSpan(span, matcher.start(), matcher.start() + group1.length(),
                        Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
...
//                UIHelper.showUrlRedirect(context, str);//TODO
            }
        });
    }
...
//                UIHelper.showUrlRedirect(context, str);//TODO
    ...
    static Spannable parseOnlyTeamTask(final Context context, CharSequence content) {
        return assimilate(content, PatternTeamTask, 1, 2, new OnClickListener() {
            @Override
            public void onClick(String str) {
//                UIHelper.openInternalBrowser(context, str);//TODO
            }
        });
    }
}
