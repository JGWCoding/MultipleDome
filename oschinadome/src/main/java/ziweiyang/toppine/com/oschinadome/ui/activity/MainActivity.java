...
import ziweiyang.toppine.com.oschinadome.adapter.BDLocationAdapter;
import ziweiyang.toppine.com.oschinadome.adapter.RadarSearchAdapter;
...
import ziweiyang.toppine.com.oschinadome.ui.fragment.NavFragment;
...
import ziweiyang.toppine.com.oschinadome.utils.CheckUpdateManager;
import ziweiyang.toppine.com.oschinadome.utils.SimplexToast;
import ziweiyang.toppine.com.oschinadome.utils.StringUtils;
import ziweiyang.toppine.com.oschinadome.utils.TDevice;
import ziweiyang.toppine.com.oschinadome.utils.db.API;
import ziweiyang.toppine.com.oschinadome.utils.db.Behavior;
...
public class MainActivity extends BaseActivity implements NavFragment.OnNavigationReselectListener,
    ...
    @Override   //从别的Activity跳过来,并这个Activity已打开  而且 launchmode="singleTask"
...
//        checkLocation();    //位置权限是否开启
    ...
    @Override
    public void call(Version version) {     //RequestPermissions接口实现
        this.mVersion = version;
        requestExternalStorage(); //请求权限
    }
