...
import ziweiyang.toppine.com.oschinadome.bean.About;
...
import ziweiyang.toppine.com.oschinadome.bean.TweetLikeReverse;
import ziweiyang.toppine.com.oschinadome.net.OSChinaApi;
import ziweiyang.toppine.com.oschinadome.other.AppOperator;
import ziweiyang.toppine.com.oschinadome.ui.view.IdentityView;
import ziweiyang.toppine.com.oschinadome.ui.view.PortraitView;
import ziweiyang.toppine.com.oschinadome.ui.view.TweetPicturesLayout;
import ziweiyang.toppine.com.oschinadome.ui.view.TweetTextView;
...
import ziweiyang.toppine.com.oschinadome.utils.parser.TweetParser;
    ...
    protected void onBindDefaultViewHolder(RecyclerView.ViewHolder h, final Tweet item, int position) {
        ...
        if (author == null) {
            ...
            holder.mViewPortrait.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
//                    OtherUserHomeActivity.show(mContext, author);//TODO
                }
            });
...
//        PlatfromUtil.setPlatFromString(holder.mViewPlatform, item.getAppClient());//TODO
...
//        UIHelper.showDetail(mContext, about.getType(), about.getId(), about.getHref());//TODO
    }
