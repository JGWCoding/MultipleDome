...
public class ApiHttpClient {
    ...
    public static void init(Application context) {  //
        ...
        client.setConnectTimeout(5 * 1000); //设置连接超时5s
        client.setResponseTimeout(7 * 1000);//设置返回解析超时7s
        //client.setCookieStore(new PersistentCookieStore(context));
        // Set
        ApiHttpClient.setHttpClient(client, context);   //CLIENT 设置参数
        // Set Cookie
    ...
    private static void initSSL(AsyncHttpClient client) {   //设置https验证允许host开头的网址
        try {
