    ...
    public void enable_bluetooth(View view) {
        ...
        if (bluetoothAdapter != null) {
            ...
            if (!bluetoothAdapter.isEnabled()) {
                ...
                Toast.makeText(MainActivity.this,"已经开启蓝牙了",Toast.LENGTH_LONG).show();
            }
...
//            devices.addAll(bluetoothAdapter.getBondedDevices());
    ...
    public void callBack(int position) {
        ...
        if (device==null) {
            Toast.makeText(MainActivity.this,"devices==null",Toast.LENGTH_LONG).show();
            Log.e("qqq","device == null");
            return;
        }
        // 连接
